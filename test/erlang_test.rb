...
class ErlangTest < Minitest::Test
  ...
  def test_is_float
    ...
    assert Erlang.is_float(BigDecimal.new('1'))
    assert Erlang.is_float(Rational(1, 2))
    assert Erlang.is_float(Erlang.from(1.0))
    assert Erlang.is_float(Erlang.from(BigDecimal.new('1')))
  ...
  def test_is_number
    ...
    assert Erlang.is_number(BigDecimal.new('1'))
    ...
    assert Erlang.is_number(Erlang.from(BigDecimal.new('1')))
  ...
  def test_type
    ...
    assert_equal :number, Erlang.type(BigDecimal.new('1'))
